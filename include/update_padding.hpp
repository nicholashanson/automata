...
namespace conway {
    ...
    void update_padding( board<array, mdspan>& bd ) {
        ...
        const size_t bottom_padding = bd.get_board_height() - 1;
        const size_t bottom_index = bd.get_board_height() - 2;
        const size_t right_padding = bd.get_board_width() - 1;
        const size_t right_index = bd.get_board_width() - 2;
